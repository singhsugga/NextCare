 <!DOCTYPE html>
  ...
  <title>NEXT CARE | PAGA TRACKER</title>
...
if ($result->num_rows > 0){
    while($row = $result->fetch_assoc()) {
        ?>
        <div class="col s11 m6 l12"> <?php $hg=$row["data"]; if($hg<=12){ echo '
          <div class="card red darken-500">';} else {echo '<div class="card green darken-500">';}?>
            <div class="card-content white-text">
        
              <span class="card-title"><?php echo $row["name"];?></span>
              <p><?php echo $row["weight"];?><br>Hb:<?php echo $row["data"];?><br><b><?php echo $row["test"];?><br></p>
            </div>
...
else 
{
	...
	//echo "<script>location.replace(\"paga.php\")</script><br>";
    ...
    <form class="col s12" method="post" action="data.php">
      <div class="row">
        ...
        <div class="input-field col s12">
          ...
          <input id="icon_telephone" type="tel" class="validate black-text" name="weight">
          <label for="icon_telephone">Weight</label>
        </div>
