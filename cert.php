...
asd
          ...
          <div class="card green darken-500">
            <div class="card-content white-text">
              ...
              <p>Now its time to give identity to your child.<br><br>
              1.Take a selfie consist of child,mother,Father & a hospital staff.<br>
              2.Fill the proper Details.<br>
              3.Get your Birth Certificate.<br>
              </p>
            </div>
          </div>
    ...
    <form class="col s12">
      <div class="row">
        <div class="input-field col s12">
          ...
          <label for="icon_prefix">Name of Infant</label>
        </div>
        <div class="input-field col s12">
      ...
      <div class="file-path-wrapper">
        <input class="file-path validate" type="text" placeholder="Attach Photo">
      </div>
    </div>
        </div>
      ...
      <div class="file-path-wrapper">
        <input class="file-path validate" type="text" placeholder="Attach Hospital provided certificate">
      </div>
    </div>
        </div>
         ...
         <div class="input-field col s12">
          ...
          <label for="icon_telephone">Father's Aadhar Number</label>
        </div>

         <div class="input-field col s12">
          
          <input id="icon_telephone" type="text" class="validate">
          <label for="icon_telephone">Mother's Aadhar Number</label>
        </div>
        ...
        <div class="input-field col s12">
           ...
           <button class="btn waves-effect waves-light" style="background-color:#0d47a1;" type="submit" name="action">Submit
